...
import ResetePasswordHook from '../../pojectHooks/Auth/resete-passwod-hook';

const ResetePasswordPage = () => {

    const [password, confirmPassword , OnChangePassword, OnChangeConfirmPassword, onSubmit, loading , isPress]= ResetePasswordHook();
    return (
        ...
        <Col xs='12' className=' d-flex justify-content-center align-items-center mb-4'>
            ...
            <Col xs='12' md='7'  className="d-flex flex-column ">
                <label className="mx-auto title-login text-light">أدخل كلمة السر الجديدة</label>
                <input
